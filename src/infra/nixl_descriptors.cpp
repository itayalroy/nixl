...
nixlRemoteDesc::nixlRemoteDesc(bool is_empty) : nixlBasicDesc(), isEmpty_(is_empty) {}
...
nixlRemoteDesc::nixlRemoteDesc(const uintptr_t &addr,
    ...
    : nixlBasicDesc{addr, len, dev_id},
      remoteAgent_{agent_name},
      isEmpty_{false} {}

nixlRemoteDesc::nixlRemoteDesc(const nixlBasicDesc &desc, const nixl_blob_t &agent_name)
    : nixlBasicDesc(desc),
      remoteAgent_(agent_name),
      isEmpty_{false} {}
